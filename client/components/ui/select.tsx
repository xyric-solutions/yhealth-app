...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-muted-foreground w-full px-2 py-1.5 text-xs", className)}
      {...props}
    />
  )
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-border pointer-events-none -mx-1 my-1 w-full  h-px", className)}
      {...props}
    />
  )
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "flex cursor-default w-full  items-center justify-center py-1",
        className
      )}
      {...props}
    >
