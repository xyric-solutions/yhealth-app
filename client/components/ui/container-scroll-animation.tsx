  ...
  return (
    ...
    >
      ...
      >
        ...
        <ContainerScrollCard rotate={rotate} translate={translate} scale={scale}>
          {children}
        </ContainerScrollCard>
      </div>
    </div>
...
export interface ContainerScrollHeaderProps {
  translate: MotionValue<number>;
  titleComponent: string | React.ReactNode;
}

export function ContainerScrollHeader({ translate, titleComponent }: ContainerScrollHeaderProps) {
  return (
    <motion.div
