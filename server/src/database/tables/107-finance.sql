...
-- 1. Finance Profiles (user settings & preferences)
...
-- 3. Budgets (per-category monthly limits)
...
-- 5. AI Insights (generated by AI analysis)
...
-- 6. Monthly Snapshots (pre-aggregated for performance)
